      ...
      <div className='w-[70vw] mx-auto my-3'>
        <div className='flex flex-col h-[90vh] justify-center items-center gap-5'>
            ...
            <button className="btn bg-red-500 text-white shadow-lg border-0 shadow-red-500/50">
              ...
              {!localStorage.getItem('userName') && <div className='flex flex-col gap-5 text-slate-400 justify-center items-center'> <hr className='w-[50vw] my-12' /> <Link to='signin'> <button className='bg-slate-700 border-2 border-slate-400 rounded-lg px-3 py-2 text-white'>Sign In</button></Link></div>}
        </div>
      </div>
    </div>
  )
